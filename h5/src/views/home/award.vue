<template>
  <div class="home">
    <Language />
    <!-- <p class="img_box">
            <img @click="changeLanguage('en')"
                 class=""
                 src="../../assets/en.png"
                 alt="" />
            <img @click="changeLanguage('e')"
                 class="zn"
                 src="../../assets/e.png"
                 alt="" />
            <img @click="changeLanguage('jp')"
                 class="jp"
                 src="../../assets/jp.png"
                 alt="" />
            <img @click="changeLanguage('kn')"
                 class="kn"
                 src="../../assets/han.png"
                 alt="" />
            <img @click="changeLanguage('zh')"
                 class="e"
                 src="../../assets/ch.png"
                 alt="" />
        ...
        <div class="menuUl-box"
             v-show="menuShow">
            <ul class="menuUl">
                <li @click="exchange">
                    Exchange
                    <img src="../../assets/rjt.png"
                         alt="" />
                </li>
                <li @click="github">
                    <img class="git"
                ...
                <li @click="hysj()">{{ $t('msg.hysj') }}<img src="../../assets/rjt.png"
                         alt="" /></li>
            </ul>
        </div> -->
    <div class="box4_">
