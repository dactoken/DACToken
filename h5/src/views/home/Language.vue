<template>
  <el-dropdown class="language-content" trigger="click">
    ...
    <img @click="changeLanguage('jp')" src="../../assets/jp.png" alt="" />
    <img @click="changeLanguage('kn')" class="jp" src="../../assets/han.png" alt="" />
    <img @click="changeLanguage('e')" class="kn" src="../../assets/e.png" alt="" />
