    ...
    <div class="box">
      <div class="airdrop-item">
        ...
        <div class="content">
          ...
          <div class="btn">
            <div class="btn-item no-color"></div>
            <!-- 领取 -->
      ...
      <div class="airdrop-item">
        ...
        <div class="content">
          ...
          <div class="des">
            <p>{{ $t('msg.airdropDesFour') }}</p>
          </div>
          <div class="income-list" v-if="frozenConfig.incomeList.length">
            <div class="income-item" v-for="(item, index) in frozenConfig.incomeList" :key="index">
              <span
                >{{ $t('msg.pledgeTime') }}：<span class="data">{{ item.time }}</span></span
              >
              <span
                >{{ $t('msg.pledgeAmount') }}：<span class="data">{{ item.amount }}</span></span
              >
              <span
                >{{ $t('msg.income') }}：<span class="data">{{ item.value }}</span></span
              >
